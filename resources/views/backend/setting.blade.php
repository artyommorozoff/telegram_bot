...
@section('content')
    ...
    <div class="container">
                ...
                <div class="input-group">
                    <div class="input-group-btn">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#" class="nav-link" onclick="document.getElementById('url_callback_bot').value='{{ url('') }}'">Вставить url</a></li>
        ...
        <form id="setwebhook" action="{{ route('admin.setting.setwebhook') }}" method="post" style="display:none;">
            {{ csrf_field() }}
            <input type="hidden" name="url" id="url" value="{{ isset($url_callback_bot) ? $url_callback_bot : '' }}">
        </form>
